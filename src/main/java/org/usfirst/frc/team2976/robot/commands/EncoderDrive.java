...
public class EncoderDrive extends Command {
	...
	public EncoderDrive(double distanceInches) {
		...
		rightSource = new util.PIDSource(){
			...
			public double getInput() {
				return Robot.m_drive.rightEncoder.get();
			}
		};
		...
		leftSource = new util.PIDSource(){
			@Override
			public double getInput() {
				return Robot.m_drive.leftEncoder.get();
			}
		};


		rightTarget = Robot.m_drive.rightEncoder.get() + (distanceInches * COUNTS_PER_INCH);
		leftTarget = Robot.m_drive.leftEncoder.get() + (distanceInches * COUNTS_PER_INCH);
	...
	protected void execute() {
		...
		Robot.m_drive.tankDrive(leftOutput, rightOutput);
		stats.writeNewData(timer.get(), Robot.m_drive.rightEncoder.get(), rightOutput, rightError);
	}
